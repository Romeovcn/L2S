...
def get_reward_up(state):
	...
	if state.find("DU_1") != -1:
		reward += -100
	# elif state.find("RU_1") != -1:
	# 	reward += -5
	elif state.find("GU_1") != -1:
		reward += 100
	elif state.find("GU_2") != -1:
		reward += 20
	if state.find("GD_2") != -1 or state.find("GL_2") != -1 or state.find("GR_2") != -1:
		reward += -10
	return reward
...
def get_reward_down(state):
	...
	if state.find("DD_1") != -1:
		reward += -100
	# elif state.find("RD_1") != -1:
	# 	reward += -5
	elif state.find("GD_1") != -1:
		reward += 100
	elif state.find("GD_2") != -1:
		reward += 20
	if state.find("GU_2") != -1 or state.find("GL_2") != -1 or state.find("GR_2") != -1:
		reward += -10
	return reward
...
def get_reward_left(state):
	...
	if state.find("DL_1") != -1:
		reward += -100
	# elif state.find("RL_1") != -1:
	# 	reward += -5
	elif state.find("GL_1") != -1:
		reward += 100
	elif state.find("GL_2") != -1:
		reward += 20
	if state.find("GU_2") != -1 or state.find("GD_2") != -1 or state.find("GR_2") != -1:
		reward += -10
	return reward
...
def get_reward_right(state):
	...
	if state.find("DR_1") != -1:
		reward += -100
	# elif state.find("RR_1") != -1:
	# 	reward += -5
	elif state.find("GR_1") != -1:
		reward += 100
	elif state.find("GR_2") != -1:
		reward += 20
	if state.find("GU_2") != -1 or state.find("GD_2") != -1 or state.find("GL_2") != -1:
		reward += -10
	return reward
